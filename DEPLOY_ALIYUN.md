...
The course material progress update from 2026-05-24 adds `CourseMaterial.totalPages`, and the performance update from 2026-05-25 adds Prisma indexes, so deploy those releases with `--with-db-push`.
